...
static const char *fonts[]          = { "monospace:pixelsize=13", "JoyPixels:pixelsize=11:antialias=true:autohint=true"};
...
static Key keys[] = {
	...
	{0, 				XK_Print,  spawn	    ,{.v=screenshothost}},
	{ControlMask|ShiftMask, 	XK_Print,  spawn	    ,{.v=screenshotclip}}
